...
class Report(Base):
    ...
    screen_count = Column(INTEGER(11), nullable=False)
    screen_rate = Column(INTEGER(11), nullable=False)
    monitor_count = Column(INTEGER(11), nullable=False)
    monitor_rate = Column(INTEGER(11), nullable=False)
    intervention_count = Column(INTEGER(11), nullable=False)
