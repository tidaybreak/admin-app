...
-- 正在导出表  aicrm.calllog 的数据：~0 rows (大约)
...
-- 正在导出表  aicrm.dict 的数据：~6 rows (大约)
...
INSERT INTO `dict` (`id`, `parentId`, `remark`, `name`, `code`, `status`, `value`, `create_time`, `update_time`) VALUES
	...
	(6, 5, NULL, 'test', NULL, 1, 'ai193.ciopaas.com,be00bad65585da7e9202d30cef13a976,61a460cb2640e62246bb92166d574804', '2023-06-26 20:06:39', '2023-06-26 20:07:42');
...
-- 正在导出表  aicrm.menus 的数据：~14 rows (大约)
...
-- 导出  表 aicrm.overview 结构
CREATE TABLE IF NOT EXISTS `overview` (
  `id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 正在导出表  aicrm.overview 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `overview` DISABLE KEYS */;
/*!40000 ALTER TABLE `overview` ENABLE KEYS */;

-- 导出  表 aicrm.report 结构
CREATE TABLE IF NOT EXISTS `report` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `uid` int(11) DEFAULT NULL COMMENT '数据源',
...
INSERT INTO `report` (`id`, `uid`, `date`, `agent_name`, `company_name`, `outbound_area`, `outbound_count`, `connection_rate`, `connection_count`, `screen_pop_count`, `screen_pop_rate`, `offline_screen_pop_count`, `offline_screen_pop_rate`, `pushed_at`, `pushed_rate`, `listened_at`, `listened_rate`, `intervention_at`, `intervention_rate`, `customer_count`, `connected_customer_success_rate`, `intervention_customer_success_rate`, `create_time`, `update_time`) VALUES
	...
	(28, NULL, '2023-06-27', 'mo912143002', 'mo912143', '', 16565, 0.68, 11333, 124, 0.01, 124, 0.01, 0, 0.00, 0, 0.00, 0, 0.00, 0, 0.00, 0.00, '2023-06-27 16:30:17', '2023-06-27 16:30:17');
...
INSERT INTO `roles` (`id`, `name`, `code`, `dataScope`, `status`, `sort`, `menus`, `update_time`, `create_time`) VALUES
	(1, '系统管理员', 'ADMIN', NULL, 1, 1, '1,2,40,41,42,3,4,5,6,43,44,47,46,48', '2023-06-27 19:02:11', '2023-06-26 08:19:47'),
...
-- 正在导出表  aicrm.users 的数据：~3 rows (大约)
